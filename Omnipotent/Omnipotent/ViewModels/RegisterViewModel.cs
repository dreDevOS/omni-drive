...
namespace Omnipotent.ViewModels
{
    public class RegisterViewModel : ViewModelBase
    {
        ...
        public RegisterViewModel(INavigationService navigationService, IProfileService profileService) : base(navigationService)
        {
            _profileService = profileService;
            RegisterCommand = new Command(async () => await RegisterNewUser(), () => !IsBusy && !String.IsNullOrWhiteSpace(UserName) && !String.IsNullOrWhiteSpace(Password) && !String.IsNullOrWhiteSpace(Email));
